# Validate PRP (Pre-Execution Check)

## PRP File: $ARGUMENTS

## When to Use This Command

✅ **Use 2-validate.md for ALL PRPs:**
- Works with any PRP type (from 1-create.md, 1-story-task-create.md, or 1-cli-create.md)
- Run BEFORE executing (Step 3)
- Automatically invoked by all Step 3 execute commands
- Can also run manually for pre-flight checks

**Purpose:** Environment readiness validation
- File references exist
- URLs accessible
- Dependencies installed
- API keys configured

**Note:** This is the only Step 2 command - it works universally with all PRP types.
