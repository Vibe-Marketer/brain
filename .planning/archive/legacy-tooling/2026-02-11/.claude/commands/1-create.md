# Create BASE PRP (Deep Research)

## Feature: $ARGUMENTS

## When to Use This Command

✅ **Use 1-create.md when:**
- Building complex new features from scratch
- Need deep parallel research with multiple subagents
- Optimizing for implementation success over speed
- Require comprehensive external research and codebase analysis
- Feature has significant architectural impact

❌ **Use 1-story-task-create.md instead when:**
- Converting an existing user story/task into a PRP
- Working with defined requirements/acceptance criteria
- Need structured task decomposition

❌ **Use 1-cli-create.md instead when:**
- Working with CLI agents
- Have a feature file to start from
- Need lighter-weight research approach
