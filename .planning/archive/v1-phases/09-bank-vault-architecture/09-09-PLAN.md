...
must_haves:
  truths:
    ...
    - "Folder visibility controls access (TEAM-07: all_members, managers_only, owner_only)"
  artifacts:
...
- **TEAM-07 (folder visibility):** Default folders demonstrate visibility hierarchy:
  - Hall of Fame: `all_members` (visible to all vault members)
  - Manager Reviews: `managers_only` (managers and above only)
  - Users can create `owner_only` folders for private content
</success_criteria>
