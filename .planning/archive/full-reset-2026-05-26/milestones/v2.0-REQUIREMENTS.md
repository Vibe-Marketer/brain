...
- [x] **MCP-01**: Each organization can have one MCP server issued
- [x] **MCP-02**: MCP server scoped to organization data only
- [x] **MCP-03**: MCP can read calls, search, and perform core operations within org scope
