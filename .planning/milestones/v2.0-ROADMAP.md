...
- [x] **Phase 17: Activation + Per-Run Observability + Go-Live Hardening** — Shipped partial: observability and go-live hardening landed; 17-05 live activation held/deferred by operator
- [x] **Phase 18: Source Attribution** — Every ticket carries its true origin; the QA `source:'manual'` mis-attribution bug is killed; AdminTab filters and measures by source (completed 2026-06-13)
...
- [x] **Phase 20: Nightly QA → Fixable Tickets + Flake Suppression** — Nightly QA files deduped `nightly_qa` tickets the loop fixes, with rerun-quarantine flake suppression co-shipped (completed 2026-06-14)
- [x] **Phase 21: Sentry Debug → Fix → Resolve** — Sentry errors auto-debugged, fixed, and written back as resolved only on a SHA-matched verified-stable deploy (completed 2026-06-14)
...
**Plans**: 5 plans (4 shipped, 1 held/deferred)
Plans:
- [x] 17-01-PLAN.md — Runner run ledger, schema proof, and daemon emission
- [x] 17-02-PLAN.md — Admin run observability surface
- [x] 17-03-PLAN.md — Deterministic test-integrity push-gate
- [x] 17-04-PLAN.md — Rebase/replay and sustained-operation guards
- [ ] 17-05-PLAN.md — HELD/DEFERRED by operator: controlled production live activation drill
...
**Plans**: 5 plans
Plans:
- [x] 19-01-PLAN.md — Durable trust schema for survival, autonomy, canary attribution, and generated types
- [x] 19-02-PLAN.md — Admin survival trust metrics and audited category promotion
- [x] 19-03-PLAN.md — Conservative throughput controls and rate-limit defer handling
- [x] 19-04-PLAN.md — Category-trust-gated approval merge and survival/canary scheduling
- [x] 19-05-PLAN.md — Canary regression reopen and tier-2 solution digest routing
...
**Plans**: 4 plans
Plans:
- [x] 20-01-PLAN.md — Nightly QA finding lanes, `ingest_qa_ticket`, evidence messages, and generated types
- [x] 20-02-PLAN.md — Autopilot QA triage ingestion with reproduced-finding gating
- [x] 20-03-PLAN.md — Flake suppression, rerun quarantine, and review-lane routing
- [x] 20-04-PLAN.md — QA-sourced ticket loop handling with per-source budget
...
- [x] 21-06-PLAN.md — [autopilot] SEN-05 daemon resolve caller: verified-stable + quiet-window + cap gate, oscillation freeze+page (NO-ANALOG invoke seam checkpoint)
...
|-------|----------------|--------|-----------|
| 17. Activation + Observability + Hardening | 4/5 | Partial — 17-05 held/deferred by operator | 2026-06-15 |
| 18. Source Attribution | 5/5 | Complete | 2026-06-13 |
| 19. Throughput + Trust/Survival/Autonomy | 5/5 | Complete   | 2026-06-13 |
| 20. Nightly QA → Tickets + Flake Suppression | 4/4 | Complete | 2026-06-14 |
| 21. Sentry Debug → Fix → Resolve | 6/6 | Complete | 2026-06-14 |
...
---
*Last updated: 2026-06-15 — v2.0 closeout: Phases 18–23 complete; Phase 17 shipped partial with 17-05 live activation held/deferred by operator.*
