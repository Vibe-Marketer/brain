...
- [x] 38-15-PLAN.md — Run full committed-tree, real-DB, browser, security, and source-coverage verification.

**Wave 10** *(blocked on Wave 9 completion)*

- [x] 38-16-PLAN.md — Run the production preflight; stopped safely before mutation on missing canary, legacy-invariant mismatch, and schema drift.
...
- [x] 39-01 — Database fixtures and real-DB discovery/privacy contracts
- [x] 39-03 — Service, component, and browser contracts

**Wave 2 *(blocked on Wave 1 contracts)* — server foundations**

- [x] 39-02 — Invitation and claim Edge integration contracts
- [x] 39-04 — Verified-email discovery authorization and safe projection
...
- [x] 39-15 — Future-event in-app notifications

**Wave 8 *(blocked on Events and claim surfaces)* — routing and navigation**

- [x] 39-14 — Routes, desktop/mobile navigation, and browser flow
