...
| 18-01-03 | 01 | 1 | SRC-01, SRC-03 | T-18-02/T-18-03 | Backfill is targeted; metrics RPC is admin-guarded | static SQL | `grep -v '^--' supabase/migrations/20260613180500_source_attribution_backfill_metrics.sql \| grep -E "ticket_source_metrics\|avg_cycle_time_hours\|context->>'origin'\|reporter_id IS NULL"` | ✅ | ⬜ pending |
...
| 18-04-01 | 04 | 2 | SRC-02 | T-18-12 | Source labels never expose raw enum values | unit/static | `npm test -- src/lib/__tests__/ticket-display.test.ts src/components/settings/__tests__/TicketTable.test.tsx && ! grep -RnE "nightly_qa\|in_app_user\|internal" src/pages/admin src/components/settings --include='*.tsx'` | ❌ W0 creates/extends | ⬜ pending |
