...
| 19-03-02 | 03 | 2 | ACT-02, TRU-01 | T-19-12/T-19-13 | Rate-limit defer releases claim with backoff and is not failure | bun unit | `cd /Users/admin/dev/autopilot && bun test src/lib/claim.test.ts` | ✅ | ⬜ pending |
...
| 19-04-01 | 04 | 3 | TRU-01, TRU-02 | T-19-14/T-19-17 | Ladder helper fails closed; auto-demotion on survival drop | bun unit | `cd /Users/admin/dev/autopilot && bun test src/lib/trust.test.ts` | ❌ W0 | ⬜ pending |
...
| 19-05-03 | 05 | 4 | TRU-02, ACT-02 | T-19-20/T-19-21/T-19-22 | Tier-2 obeys ladder and emits solution digest only; one-cycle schedules preserve concurrency | bun unit/type/static | `cd /Users/admin/dev/autopilot && bun test src/lib/tier2.test.ts src/lib/trust.test.ts src/lib/canary.test.ts && bun run typecheck` | ❌ W0 | ⬜ pending |
