...
must_haves:
  truths:
    - "14-RESEARCH.md was consulted and stack is validated before scaffolding"
...
<task type="auto">
  ...
  <action>
    0. GUARD — Verify 14-RESEARCH.md exists and validate stack (FOUND-02):
       ```
       ls /Users/Naegele/dev/brain/.planning/phases/14-foundation/14-RESEARCH.md
       ```
       If it does NOT exist, STOP and report: "FOUND-02 requires tech stack validation via deep research before repo creation. Run /gsd:research-phase 14 first."
       If it exists, read it and confirm the stack decisions (Vite 7, React 19, TanStack Router, TailwindCSS v4, Motion, Zustand v5, TanStack Query v5) match what this plan installs. If any dependency version or library choice in 14-RESEARCH.md contradicts this plan, adapt this plan's install commands to match the research. Log any adaptations in the SUMMARY.
  ...
  <verify>
    - `ls /Users/Naegele/dev/brain/.planning/phases/14-foundation/14-RESEARCH.md` exists (FOUND-02 guard)
  ...
  <done>14-RESEARCH.md was consulted and stack validated. Vite 7 dev server starts successfully at localhost:3000. All 15+ dependencies installed. TanStack Router plugin generates routeTree.gen.ts on first dev start. No AI code, no Google Meet code, no tailwind.config.js.</done>
</task>
