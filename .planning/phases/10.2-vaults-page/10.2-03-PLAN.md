...
<objective>
Implement vault CRUD operations — create, edit, and delete vaults with mutation hooks and dialog components. The Create Vault button in VaultListPane header is wired up.
