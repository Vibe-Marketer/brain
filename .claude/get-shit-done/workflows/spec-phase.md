...
```bash
INIT=$(node "/Users/admin/dev/brain/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/admin/dev/brain/.claude/get-shit-done/templates/spec.md.
