...
```markdown
Read /Users/admin/dev/brain/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/admin/dev/brain/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/admin/dev/brain/.claude/agents/gsd-ui-checker.md for instructions.
