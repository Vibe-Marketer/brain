...
```
Agent(
  prompt="Read /Users/admin/dev/brain/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/admin/dev/brain/.claude/get-shit-done/templates/VALIDATION.md`
