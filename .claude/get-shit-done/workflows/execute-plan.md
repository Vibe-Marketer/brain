...
@/Users/admin/dev/brain/.claude/get-shit-done/references/git-integration.md
</required_reading>
...
See `/Users/admin/dev/brain/.claude/get-shit-done/references/tdd.md` for structure.
</tdd_plan_execution>
...
See /Users/admin/dev/brain/.claude/get-shit-done/references/checkpoints.md for details.
</step>
...
Create `{phase}-{plan}-SUMMARY.md` at `.planning/phases/XX-name/`. Use `/Users/admin/dev/brain/.claude/get-shit-done/templates/summary.md`.
