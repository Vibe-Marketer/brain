...
<required_reading>
@/Users/admin/dev/brain/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/Users/admin/dev/brain/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/admin/dev/brain/.claude
                  → checks /Users/admin/dev/brain/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/admin/dev/brain/.claude/get-shit-done
                  → writes to /Users/admin/dev/brain/.claude/get-shit-done/hooks/
...
@/Users/admin/dev/brain/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/admin/dev/brain/.claude/get-shit-done/references/common-bug-patterns.md
