...
✅ **Use 1-story-task-create.md when:**
- Converting existing user story/task into implementation PRP
- Have defined acceptance criteria or requirements
- Need systematic task decomposition and story analysis
- Working with agile story format
- Medium complexity features with clear scope

❌ **Use 1-create.md instead when:**
- Building complex new features from scratch
- Need maximum research depth with parallel subagents
- Feature is architecturally significant

❌ **Use 1-cli-create.md instead when:**
- Working with CLI agents
- Need simpler research approach
