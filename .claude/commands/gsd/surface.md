...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/admin/dev/brain/.claude/.gsd-surface.json`
(sibling to `/Users/admin/dev/brain/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/admin/dev/brain/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/admin/dev/brain/.claude/skills`).
...
`/Users/admin/dev/brain/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/admin/dev/brain/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/admin/dev/brain/.claude/.gsd-surface.json`
Install profile marker: `/Users/admin/dev/brain/.claude/.gsd-profile`
Skill dirs: `/Users/admin/dev/brain/.claude/skills/gsd-*/`
Engine module: `/Users/admin/dev/brain/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/Users/admin/dev/brain/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
