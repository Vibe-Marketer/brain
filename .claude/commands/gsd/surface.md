...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/admin/dev/brain/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=/Users/admin/dev/brain/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=/Users/admin/dev/brain/.claude/commands/gsd
AGENTS_DIR=/Users/admin/dev/brain/.claude/agents
```
...
<execution_context>
Surface state file: `/Users/admin/dev/brain/.claude/skills/.gsd-surface.json`
Install profile marker: `/Users/admin/dev/brain/.claude/skills/.gsd-profile`
