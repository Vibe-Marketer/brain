...
export function mapRecordingToMeeting(recording: WorkspaceRecording): Meeting {
  ...
  const result: Meeting = {
    ...
    url: (meta.fathom_url as string) || (meta.zoom_share_url as string) || (meta.share_url as string) || null,
    share_url: (meta.fathom_share_url as string) || (meta.zoom_share_url as string) || (meta.share_url as string) || null,
