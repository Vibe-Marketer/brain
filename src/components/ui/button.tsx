        ...
        return (
          <Comp
            ...
            className={cn(
              ...
              'border border-border dark:border-cb-border-dark',
              'bg-white dark:bg-card',
              'text-ink dark:text-white',
              'hover:bg-hover dark:hover:bg-cb-panel-dark',
        ...
        return (
          <Comp
            ...
            className={cn(
              size === 'icon-sm' ? 'h-6 w-6' : 'h-8 w-8',
              'inline-flex items-center justify-center gap-1 whitespace-nowrap rounded-md text-sm font-medium',
              'border border-soft dark:border-cb-border-dark',
              'bg-transparent',
              'text-ink-soft dark:text-cb-text-dark-secondary',
              'hover:bg-hover hover:text-ink hover:border-border',
      ...
      return (
        <Comp
          ...
          className={cn(
            ...
            'text-ink-soft dark:text-cb-text-dark-secondary',
            'border-soft dark:border-cb-border-dark',
            'hover:bg-hover hover:text-ink hover:border-border',
