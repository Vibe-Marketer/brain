  ...
  if (!folder) {
    return (
      <div className="p-4 space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="font-semibold text-foreground">Folder Not Found</h3>
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        ...
        <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); handleSave(); }} aria-label="Edit folder form">
          <h4 className="text-xs font-semibold text-muted-foreground uppercase tracking-wide" id="edit-folder-heading">
            Edit Folder
          </h4>
