/**
 * WorkspaceInviteDialog - Generate and share workspace invite links
 *
 ...
 *
 * Permission: Only workspace_owner or workspace_admin can generate/see invite link
 *
 * @pattern dialog
 * @brand-version v4.2
 */
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Share this link with anyone you want to invite. They'll join this workspace as a member.
          </DialogDescription>
        </DialogHeader>
