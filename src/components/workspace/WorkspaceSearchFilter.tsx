/**
 * WorkspaceSearchFilter - Search input and filter controls for workspace recordings
 *
 ...
 *
 * @pattern workspace-filter-toolbar
 * @brand-version v4.2
 */
...
export interface WorkspaceSearchFilterProps {
