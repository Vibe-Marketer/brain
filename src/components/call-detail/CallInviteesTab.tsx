...
export function CallInviteesTab({
  calendarInvitees,
  callSpeakers,
}: CallInviteesTabProps) {
          ...
          {hasInvitees ? (
            ...
            <div className="space-y-6">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p>
                          No calendar invitees found. Showing speakers from the
                          transcript instead.
                        </p>
                      </TooltipContent>
                    </Tooltip>
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  This appears to be an impromptu or ad-hoc call — no calendar
                  invitees were found. Showing transcript speakers instead.
                </p>
              </div>
              <div className="space-y-3">
