...
1. Click your organization name in the top navigation — the switcher displays the actual name of your current organization
...
The person who creates the organization is automatically the owner. Ownership can be transferred to another admin from the **Members** category on the Organization page.

## Organization settings

Open the **Organization** page from the sidebar to:

- View and edit your organization name directly from the Overview
- Manage workspaces
