...
The person who creates the organization is automatically the owner. Ownership can be transferred to another admin in **Settings → Organizations → Members**.

## Organization settings

Go to **Settings → Organizations** to:
