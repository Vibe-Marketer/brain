...
2. Use the organization switcher at the top of the category pane
...
The person who creates the organization is automatically the owner. Ownership can be transferred to another admin in **Organization → Members**.

## Organization page

The **Organization** page in the left sidebar is your central hub for managing everything at the org level. It has four sections:

- **Overview** — see your organization name, type, creation date, member count, workspace count, and your role
- **Workspaces** — create and manage all workspaces within the organization
- **Members** — view and manage team members and their roles
- **Settings** — rename the organization or delete it (owners only)
