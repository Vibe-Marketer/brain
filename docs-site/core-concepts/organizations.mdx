...
The person who creates the organization is automatically the owner. Ownership can be transferred to another admin from **People → Members** in the sidebar.

## Organization settings

Organization management is split across two areas:

- **People** (in the sidebar) — manage members, roles, contacts, and pending invites
- **Settings → Billing** — view and update your subscription plan
- **Settings → Admin** — configure org-wide defaults (admin only)
