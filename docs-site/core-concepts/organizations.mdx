...
The organization switcher is also available at the top of the **People** and **Import** sidebars, so you can switch context without leaving the page you're working in.
