---
title: "Folders"
description: "Organize calls inside a CallVault workspace using folders. Create nested folder structures by client, project, or date to keep your call library tidy."
icon: "folder"
---
