---
title: "Calls: the core record for every meeting recording"
description: "See what a CallVault call record contains — recording, transcript, speaker labels, AI summary, action items, and tags — and how it powers the whole app."
icon: "phone"
---
