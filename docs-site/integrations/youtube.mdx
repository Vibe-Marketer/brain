...
When you open the YouTube import form, a **Destination workspace** dropdown lets you choose which workspace the imported video lands in. By default, it selects your personal My Calls workspace, but you can pick any workspace you have access to.

CallVault remembers your last-used workspace for YouTube imports, so the next time you import a video the same workspace is pre-selected.

<Tip>
  If you always import YouTube videos into the same workspace, just select it once — CallVault remembers your choice for future imports.
</Tip>

You can also use [Routing Rules](/automation/routing-rules) to automatically move or tag imported videos based on title keywords or other conditions.
