...
description: "Paste any public YouTube video URL into CallVault to automatically extract its transcript, metadata, and duration — no OAuth or login required."
icon: "circle-play"
---
