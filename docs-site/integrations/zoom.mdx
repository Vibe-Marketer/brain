...
<Steps>
  ...
  <Step title="Confirm the connection">
    You'll be redirected back to CallVault. The Zoom integration should now show as **Connected**. CallVault automatically detects your Zoom account email during this step so incoming recordings can be matched to your account.
  </Step>
</Steps>
...
<AccordionGroup>
  <Accordion title="My Zoom recordings aren't showing up in CallVault">
    First, verify that cloud recording is enabled in your Zoom account settings. Then check that the Zoom integration is still showing as **Connected** in CallVault. If it shows as disconnected, reconnect — this also re-detects your Zoom account email, which is required for recording delivery. If recordings still aren't appearing after reconnecting, contact [support](/reference/support).
  </Accordion>
