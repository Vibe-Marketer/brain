...
- **Date and duration**
- **Host** — the meeting host is identified and shown in the transcript view
- **Participants** — speaker names are extracted from the transcript and listed as call participants
- **Summary** — meeting summary from Zoom when available
