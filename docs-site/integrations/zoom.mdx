...
Zoom recordings land in your **My Calls** workspace by default. You can change the default destination during initial setup by choosing a different workspace in the import settings.

To route calls automatically to a shared workspace or folder, set up a [Routing Rule](/automation/routing-rules) using meeting title keywords as the condition.
