...
<AccordionGroup>
  ...
  <Accordion title="My Zoom connection shows as 'Connected (Legacy)'">
    If you connected Zoom before CallVault's updated import system, your connection may appear as **Connected (Legacy)**. This works the same as a modern connection — your calls still sync normally. You can disconnect a legacy connection at any time from **Settings → Integrations → Zoom** and reconnect to upgrade to the current integration format.
  </Accordion>
</AccordionGroup>
