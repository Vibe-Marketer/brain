...
<Steps>
  ...
  <Step title="Click Connect next to Zoom">
    A new browser tab opens with Zoom's authorization page. Your current CallVault page stays open so you don't lose your place.
  </Step>
  <Step title="Authorize CallVault">
    In the new tab, sign in to Zoom (if not already) and click **Allow** to grant CallVault access to your cloud recordings.
  </Step>
  <Step title="Return to CallVault">
    After authorizing, the tab closes and CallVault updates automatically. The Zoom integration should now show as **Connected**.
  </Step>
</Steps>
