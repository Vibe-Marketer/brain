...
<Steps>
  ...
  <Step title="Click Connect next to Fathom">
    A new browser tab opens with Fathom's authorization page. Your current CallVault page stays open so you don't lose your place.
  </Step>
  <Step title="Sign in to Fathom and authorize">
    In the new tab, log in with your Fathom credentials and grant CallVault permission to access your recordings.
  </Step>
