...
<AccordionGroup>
  ...
  <Accordion title="My Fathom connection shows as 'Connected (Legacy)'">
    If you connected Fathom before CallVault's updated import system, your connection may appear as **Connected (Legacy)**. This works the same as a modern connection — your calls still sync normally. You can disconnect a legacy connection at any time from **Settings → Integrations → Fathom** and reconnect to upgrade to the current integration format.
  </Accordion>
</AccordionGroup>
