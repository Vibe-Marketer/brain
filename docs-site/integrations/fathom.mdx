...
When you connect Fathom, CallVault automatically sets your host email based on your Fathom account. This lets CallVault identify which speaker is "you" in every transcript — no manual setup required.

If you have multiple Fathom accounts connected, CallVault recognizes you as the host across all of them. Any call recorded by any of your connected Fathom accounts is correctly attributed to you.

<Info>
  Your host email is visible in **Settings → Account**. It's set automatically when you first connect Fathom, but you can change it manually at any time.
</Info>
...
<AccordionGroup>
  ...
  <Accordion title="Transcripts don't show me as the speaker / host">
    CallVault sets your host email automatically when you first connect Fathom. If your host email is missing or incorrect, check **Settings → Account** and verify it matches the email on your Fathom account. If you use multiple Fathom accounts, all connected account emails are checked automatically.
  </Accordion>
</AccordionGroup>
