...
<Steps>
  <Step title="Open the Import page">
    In CallVault, click **Import** in the sidebar, then select **Fathom**.
  </Step>
...
1. Click **Import** in the sidebar and select **Fathom**
...
<AccordionGroup>
  <Accordion title="My calls aren't showing up after connecting">
    The initial import can take a few minutes for large libraries. Check **Import → Fathom** for the sync status. If the import shows as complete but calls are missing, try disconnecting and reconnecting.
  </Accordion>
  <Accordion title="New calls from Fathom aren't syncing">
    Make sure the Fathom integration is still connected — check **Import → Fathom** in the sidebar. If your Fathom password changed recently, you may need to reconnect.
  </Accordion>
