---
title: "File Upload"
description: "Upload audio or video files directly to CallVault from any source. Uploaded recordings are transcribed and summarized like any integrated call."
icon: "upload"
---
