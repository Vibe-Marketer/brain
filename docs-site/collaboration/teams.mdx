---
title: "Teams: bulk-manage workspace access for groups"
description: "Group members into teams so you can assign or remove workspace access for entire departments at once instead of updating each person individually."
icon: "users"
---
