...
description: "Compare the Viewer, Editor, and Admin roles in CallVault workspaces. See which permissions each role has for calls, folders, members, and settings."
icon: "shield-halved"
---
