---
title: "Workspace roles: Viewer, Editor, and Admin permissions"
description: "Compare the Viewer, Editor, and Admin workspace roles in CallVault and learn exactly which call, folder, and member actions each permission level allows."
icon: "shield-halved"
---
