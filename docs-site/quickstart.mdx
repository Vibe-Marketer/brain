...
<Tabs>
  ...
  <Tab title="Zoom (coming soon)">
    The Zoom integration is coming soon. In the meantime, you can download your Zoom cloud recordings and [upload them directly](/integrations/upload).

    See the [Zoom integration page](/integrations/zoom) for more details on what's planned.
  </Tab>
  <Tab title="YouTube">
