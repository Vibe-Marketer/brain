...
<Tabs>
  <Tab title="Fathom">
    1. Go to **Import** and select **Fathom**
    2. Click **Connect Fathom** and sign in to your Fathom account
    3. Authorize CallVault to access your recordings
    4. Select a date range, choose calls, pick a workspace, and import

    You can connect multiple Fathom accounts if you record under different emails. See the [Fathom integration guide](/integrations/fathom) for full details.
  </Tab>
  <Tab title="Zoom (coming soon)">
    The Zoom integration is coming soon. In the meantime, download your cloud recordings from Zoom and use [file upload](/integrations/upload) to bring them into CallVault.

    See the [Zoom integration guide](/integrations/zoom) for what to expect when it launches.
  </Tab>
  <Tab title="YouTube">
