...
<Steps>
  ...
  <Step title="Create or join an organization">
    When you sign up for the first time, CallVault creates a personal organization for you automatically. You can rename it or create a new one for your team in **Settings → Organizations**.
