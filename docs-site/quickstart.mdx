...
<Steps>
  <Step title="Sign up">
    Go to [app.callvault.ai/signup](https://app.callvault.ai/signup) and choose how you'd like to create your account:

    - **Continue with Google** — sign up instantly with your Google account (recommended for teams using Google Workspace)
    - **Email and password** — enter your work email and choose a password (minimum 6 characters)
    - **Magic link** — enter your email and click "Send me a magic link" to sign in without a password. Check your inbox for a one-click login link.

    <Tip>
      Magic link sign-in works for both new and existing accounts. If you prefer not to manage a password, you can always sign in this way from the sign-in screen.
    </Tip>
  </Step>
