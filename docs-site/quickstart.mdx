...
<Steps>
  ...
  <Step title="Create or join an organization">
    When you sign up for the first time, CallVault creates a personal organization for you automatically. You can rename it or create a new one for your team from the organization switcher in the top navigation.
...
<Tabs>
  <Tab title="Fathom">
    1. Click **Import** in the sidebar, then select **Fathom**
  ...
  <Tab title="Zoom">
    1. Click **Import** in the sidebar, then select **Zoom**
