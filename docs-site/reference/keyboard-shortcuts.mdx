...
description: "Browse the full list of CallVault keyboard shortcuts for navigating calls, controlling playback, searching transcripts, and managing your workspace."
icon: "keyboard"
---
