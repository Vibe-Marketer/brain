...
description: "Browse all keyboard shortcuts for navigating CallVault, controlling audio playback, managing transcripts, and searching across your call library."
icon: "keyboard"
---
