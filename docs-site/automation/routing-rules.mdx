---
title: "Routing rules to auto-tag and file incoming calls"
description: "Set up routing rules that automatically tag calls and move them into folders based on meeting title, caller name, duration, and other conditions."
icon: "route"
---
