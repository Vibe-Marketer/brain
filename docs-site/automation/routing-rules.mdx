---
title: "Routing Rules"
description: "Set up routing rules in CallVault to automatically sort incoming calls into folders and apply tags based on meeting title, caller, or duration."
icon: "route"
---
