# CALLVAULT BRAND GUIDELINES v3.4
...
> 4. **MINOR versions only:** Update filename (e.g., v3.4 -> v3.5 = rename file)
>
...
10. [Vibe Orange Usage Rules](#vibe-orange-usage-rules)
...
| Name | Hex | HSL | Usage |
|------|-----|-----|-------|
| **Vibe Orange** | #FF8800 | 32 100% 50% | Active indicators only |
| **Vibe Orange Light** | #FFA940 | 32 100% 63% | Hover states |
| **Vibe Orange Dark** | #E67700 | 32 100% 45% | Active pressed |

**CRITICAL:** Vibe orange appears in EXACTLY 5 contexts (see dedicated section below).
...
|-----------|-----|-------------|
| Text color | Can impact readability | Black (#111111) |
...
| #FF8800 on #FFFFFF | 3.1:1 | AA (UI only, not text) |
...
| Vibe orange text | Can impact readability | Black text + structural indicators |
...
:root {
  ...
  --vibe-orange-light: 32 100% 63%;   /* #FFA940 */
  --vibe-orange-dark: 32 100% 45%;    /* #E67700 */
...
### Color
- [ ] Vibe orange ONLY in 5 approved contexts
...
- Initial versions use two digits: v3.4 (not v3.4.0)
- After first patch, use three digits: v3.4.1, v3.4.2, etc.

| Change Type | Version Bump | Example | Who Decides |
|-------------|--------------|---------|-------------|
| **Patch** | X.Y -> X.Y.1 or X.Y.Z -> X.Y.Z+1 | v3.4 -> v3.4.1 -> v3.4.2 | Claude (automatic) |
| **Minor** | X.Y -> X.Y+1 | v3.4.2 -> v3.5 | Claude (flag to user if >3 sections updated) |
| **Major** | X -> X+1 | v3.5 -> v4.0 | **User only** - Never done by Claude |
...
- **MINOR versions:** Also rename the file (v3.4 -> v3.5)
- Never edit without incrementing version
- Claude never increments major version (X.0)
- **PATCH versions:** Do NOT rename file

**Examples:**
- Fixing a typo -> v3.4.1 -> v3.4.2 (no file rename)
- Updating tab section only -> v3.4.2 -> v3.4.3 (no file rename)
- Updates across 4 sections -> v3.4.3 -> v3.5 (rename to brand-guidelines-v3.5.md)
- Complete design system overhaul -> v3.5 -> v4.0 (user decision only)
...
**END OF BRAND GUIDELINES v3.4**

This document is complete and accurate as of December 5, 2025.
