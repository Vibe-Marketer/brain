...
3. **Tailwind Customization** - Easy to adapt to brand-guidelines-v4.4.md
...
Changes needed to match `brand-guidelines-v4.4.md`:
...
- [Brand Guidelines v4.4](/docs/design/brand-guidelines-v4.4.md)
