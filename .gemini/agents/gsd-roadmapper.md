...
Reference full template: `/Users/admin/dev/brain/.gemini/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/admin/dev/brain/.gemini/get-shit-done/templates/state.md`.
