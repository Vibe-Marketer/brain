...
<!-- For checkpoint task examples and patterns, see @/Users/admin/dev/brain/.gemini/get-shit-done/references/checkpoints.md -->
...
See `/Users/admin/dev/brain/.gemini/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Users/admin/dev/brain/.gemini/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/admin/dev/brain/.gemini/get-shit-done/workflows/verify-phase.md` for verification logic.
