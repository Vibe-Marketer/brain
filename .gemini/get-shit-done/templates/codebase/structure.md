...
- Usage: Reference from command with `@/Users/admin/dev/brain/.gemini/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/admin/dev/brain/.gemini/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/admin/dev/brain/.gemini/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
