...
@/Users/admin/dev/brain/.gemini/get-shit-done/references/sketch-theme-system.md
@/Users/admin/dev/brain/.gemini/get-shit-done/references/sketch-variant-patterns.md
@/Users/admin/dev/brain/.gemini/get-shit-done/references/sketch-interactivity.md
@/Users/admin/dev/brain/.gemini/get-shit-done/references/sketch-tooling.md
</required_reading>
...
**b. Findings skills** — glob `./.gemini/skills/sketch-findings-*/SKILL.md` and read any that exist, plus their `references/*.md`. These contain curated design decisions from prior wrap-ups.
...
**a.** Glob for `./.gemini/skills/spike-findings-*/SKILL.md` and read any that exist, plus their `references/*.md`. These contain validated patterns and requirements.
