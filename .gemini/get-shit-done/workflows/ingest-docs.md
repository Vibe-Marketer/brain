...
```bash
INIT=$(node "/Users/admin/dev/brain/.gemini/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/admin/dev/brain/.gemini/get-shit-done/bin/gsd-tools.cjs" commit \
