...
INSTALL_JS_GLOBAL="/Users/admin/dev/brain/.gemini/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/admin/dev/brain/.gemini/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
